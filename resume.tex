...
\begin{entrylist}
    ...
    {\vspace{-4pt}
    \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=10pt]
        \item Working on a scalable chirp radar fusion architecture to support accurate multi-object tracking across multiple radar sensors. Current features include a synchronized, real-time data pipeline leveraging Chrony for time synchronization, MQTT for data transportation, and PostgreSQL for data storage.
        \item Dockerized the full service stack to improve portability, deployment speed, and system maintainability.
    \end{itemize}
    }
