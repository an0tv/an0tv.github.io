...
\begin{entrylist}
    ...
    {\vspace{-4pt}
    \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=10pt]
        \item Sscalable chirp radar fusion architecture to support accurate multi-object tracking across multiple radar sensors, based on DCA1000EVM and AWR2243Boost hardware stack, with Jetson Orin Nano used to process sensor data. 
