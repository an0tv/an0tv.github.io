...
\vspace{-4pt}
    ...
    \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=10pt]
        \item Computer Engineering - Deep Learning, Advanced Computer Architecture, Data Structures \& Algorithms, Embedded System, Machine Learning, Circuits, VLSI
        \item Statistics \& Data Science - SAS Programming, SQL, Advanced Statistical Models, Survival Analysis, Stochastic Processes, Statistical Machine Learning, Regression Analysis, Advanced Linear Algebra
    \end{itemize}}
...
\begin{entrylist}
    ...
    \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=10pt]
        ...
        \item Current features include multi-node synced CFAR, DBSCAN, and EKF pipeline running at 20FPS.
    \end{itemize}
    }
